...
<File
  path=".prettierrc"
  content="https://github.com/mediacurrent/gatsby-recipe-mediacurrent/blob/master/recipe/prettier/.prettierrc"
/>
<File
  path=".prettierignore"
  content="https://github.com/mediacurrent/gatsby-recipe-mediacurrent/blob/master/recipe/prettier/.prettierignore"
/>
